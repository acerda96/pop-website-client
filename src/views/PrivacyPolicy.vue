<template>
  <div class="flex justify-center">
    <div class="bg-white m-10 p-8 w-5/6 xs:w-full xs:m-0 xs:my-5">
      <h1 class="text-3xl xs:text-2xl mb-5">
        Privacy Policy
      </h1>

      <p class="text-justify">
        At www.pop-marketplace.herokuapp.com, accessible from
        https://www.pop-marketplace.herokuapp.com, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by
        www.pop-marketplace.herokuapp.com and how we use it.
      </p>
      ...
      <p class="text-justify">
        ...
        shared and/or collect in www.pop-marketplace.herokuapp.com. This policy
      ...
      <h2 class="text-xl mt-5 mb-2">Consent</h2>
      ...
      <h2 class="text-xl mt-5 mb-2">Information we collect</h2>
      ...
      <h2 class="text-xl mt-5 mb-2">How we use your information</h2>
      ...
      <h2 class="text-xl mt-5 mb-2">Log Files</h2>

      <p class="text-justify">
        www.pop-marketplace.herokuapp.com follows a standard procedure of using
      ...
      <h2 class="text-xl mt-5 mb-2">Advertising Partners Privacy Policies</h2>

      <P
        >You may consult this list to find the Privacy Policy for each of the
        advertising partners of www.pop-marketplace.herokuapp.com.</P
      >
      ...
      <p class="text-justify">
        ...
        www.pop-marketplace.herokuapp.com, which are sent directly to users'
      ...
      <p class="text-justify">
        Note that www.pop-marketplace.herokuapp.com has no access to or control
        over these cookies that are used by third-party advertisers.
      </p>

      <h2 class="text-xl mt-5 mb-2">Third Party Privacy Policies</h2>

      <p class="text-justify">
        www.pop-marketplace.herokuapp.com's Privacy Policy does not apply to
      ...
      <h2 class="text-xl mt-5 mb-2">GDPR Data Protection Rights</h2>
      ...
      <h2 class="text-xl mt-5 mb-2">Children's Information</h2>
      ...
      <p class="text-justify">
        www.pop-marketplace.herokuapp.com does not knowingly collect any
