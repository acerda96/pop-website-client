<template>
  <div class="flex justify-center">
    <div class="bg-white m-10 p-8 w-5/6 xs:w-full xs:m-0 xs:my-5">
      <h1 class="text-3xl xs:text-xl xxs:text-center">
        Privacy Policy for Pop Marketplace
      </h1>

      <p class="xs:text-justify">
        At www.pop-marketplace.co.uk, accessible from
        https://www.pop-marketplace.co.uk, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by www.pop-marketplace.co.uk
        and how we use it.
      </p>
      ...
      <p class="xs:text-justify">
        ...
        shared and/or collect in www.pop-marketplace.co.uk. This policy is not
      ...
      <h2 class="text-xl mt-4">Consent</h2>
      ...
      <h2 class="text-xl mt-4">Log Files</h2>

      <p class="xs:text-justify">
        www.pop-marketplace.co.uk follows a standard procedure of using log
      ...
      <h2 class="text-xl mt-4">Advertising Partners Privacy Policies</h2>

      <P
        >You may consult this list to find the Privacy Policy for each of the
        advertising partners of www.pop-marketplace.co.uk.</P
      >

      <p class="xs:text-justify">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on www.pop-marketplace.co.uk, which
      ...
      <p class="xs:text-justify">
        Note that www.pop-marketplace.co.uk has no access to or control over
        these cookies that are used by third-party advertisers.
      </p>

      <h2 class="text-xl mt-4">Third Party Privacy Policies</h2>
      ...
      <h2 class="text-xl mt-4">GDPR Data Protection Rights</h2>
      ...
      <h2 class="text-xl mt-4">Children's Information</h2>
      ...
      <p class="xs:text-justify">
        www.pop-marketplace.co.uk does not knowingly collect any Personal
